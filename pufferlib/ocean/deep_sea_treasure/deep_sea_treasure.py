...
class DeepSeaTreasure(pufferlib.PufferEnv):
    def __init__(self,num_envs=16,gamma=0.99,report_interval=128,render_mode='human',buf=None,seed=0,**kwargs,):
        ...
        # Observation: 
        self.single_observation_space = gymnasium.spaces.Box(low=0, high=10, shape=(2,), dtype=np.uint8)
        ...
        for i in range(num_envs):
            ...
            env_id = binding.env_init(obs_slice,act_slice,rew_slice,weights_slice,term_slice,trunc_slice,env_seed,gamma=gamma,)
    ...
    def step(self, actions):
        ...
        return (self.observations,self.rewards,self.weights,self.terminals,self.truncations,infos,)
